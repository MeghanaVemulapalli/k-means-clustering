...
% Created: 18-Dec-2015
% Last modified: Meghana Vemulapalli - homework 5
    ...
    methods (Static)
        function main()
            ...
            question3.question_3_4_2(trLbs, trD);
            question3.question_3_4_3(trLbs, trD);
            [trainK, testK, bestc] = question3.question_3_4_5(trD, tstD, trLbs);
            question3.question_3_4_6(trainK, testK, trLbs, tstD, bestc);
        ...
        function bowCs = learnDictionary(scales, normH, normW)
            ...
            for i=1:1000
                prev_cluster_centre = [prev_cluster_centre;randWins(i,:)];
            end

            [new_cluster_classify, new_cluster_centre, ~] = k_means.k_means_impl(20, randWins, 1000, prev_cluster_centre);
            disp(size(new_cluster_centre));
            bowCs = new_cluster_centre.';
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
